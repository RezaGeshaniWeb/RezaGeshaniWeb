...
I'm a full stack developer who believes great software comes from curiosity, discipline, and clean, thoughtful code. I turn ideas into fast, practical web applications — from polished UIs to secure APIs and databases.
...
- 🌐 Portfolio: [rezageshani.ir](https://rezageshani.ir/)
...
| Area | Focus |
|------|--------|
| **Full-Stack Web Development** | Fast, SEO-friendly, interactive apps with Next.js and modern frameworks |
| **Frontend Development** | Responsive, accessible, high-performance UIs with React & Next.js |
| **Backend Development** | Secure, scalable server-side apps with Node.js & Express.js |
| **API & Database** | RESTful APIs and solid database layers for reliable full-stack products |
...
|---------|-------------|-------|
| **[Shop](https://rezageshani.ir/)** | Full-featured e-commerce with cart, checkout & persistent state | Next.js · React · MUI · Zustand · Tailwind |
| **[Divar](https://rezageshani.ir/)** | Classified ads platform inspired by marketplace listings | JavaScript · Express · MongoDB · Node.js |
| **[Dashboard FullStack](https://rezageshani.ir/)** | Admin dashboard with modular API & Swagger docs | Next.js · MUI · Express · MongoDB · Swagger |
| **[Crypto App](https://rezageshani.ir/)** | Live crypto dashboard with charts & toast feedback | React · Vite · Tailwind · Recharts |
| **[Admin Panel MUI](https://rezageshani.ir/)** | Analytics dashboard with charts & Leaflet maps | Next.js · MUI · MUI X-Charts · Leaflet |

> More projects, live demos & source code → **[rezageshani.ir](https://rezageshani.ir/)**
...
<div align="center">
  ...
  🌐 **[Portfolio](https://rezageshani.ir/)** &nbsp;·&nbsp;
  💼 **[LinkedIn](https://linkedin.com/in/reza-geshani-web)** &nbsp;·&nbsp;
  📸 **[Instagram](https://instagram.com/rezageshani_web)** &nbsp;·&nbsp;
  ✉️ **[Email](mailto:rezageshaniweb@gmail.com)**

  <br/>

  *Open to collaboration, freelance work, and interesting full-stack challenges.*
